...
import { IonStepsComponent } from './ion-step.component';
...
describe('Static IonStepsComponent', () => {
  ...
  it('should go to step 3 when it be clicked', async () => {
    ...
    expect(await screen.findByTestId('step-3-selected')).toBeTruthy();
...
describe('Passing through the IonStepsComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TestHostComponent, IonStepsComponent],
    }).compileComponents();
