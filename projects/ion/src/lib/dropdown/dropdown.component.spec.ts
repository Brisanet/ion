...
describe('IonDropdownComponent', () => {
    ...
    it('should render options', () => {
        const optionElements = fixture.debugElement.queryAll(By.css('.ion-dropdown-item'));
    ...
    it('should render description when provided', () => {
        ...
        fixture.detectChanges();
        const description = fixture.debugElement.query(By.css('.dropdown-description'));
    ...
    it('should select an option on click', () => {
        ...
        expect(optionElements[0].nativeElement.classList).toContain('dropdown-item-selected');
        expect(spy).toHaveBeenCalledWith([expect.objectContaining({ label: 'Option 1', selected: true })]);
    });
    ...
    it('should deselect an option on click if already selected (single selection)', () => {
        ...
        expect(optionElements[0].nativeElement.classList).not.toContain('dropdown-item-selected');
    });
    ...
    describe('Multiple Selection', () => {
        ...
        it('should select multiple options', () => {
            ...
            expect(optionElements[0].nativeElement.classList).toContain('dropdown-item-selected');
            expect(optionElements[1].nativeElement.classList).toContain('dropdown-item-selected');
        });
        ...
        it('should respect maxSelected limit', () => {
            ...
            expect(optionElements[0].nativeElement.classList).toContain('dropdown-item-selected');
            expect(optionElements[1].nativeElement.classList).not.toContain('dropdown-item-selected');
        });
    });
    ...
    describe('No Data', () => {
        it('should render no data message when options are empty', () => {
            ...
            const noData = fixture.debugElement.query(By.css('[data-testid="ion-no-data"]'));
    ...
    describe('Loading', () => {
        it('should render spinner when loading is true', () => {
            ...
            const spinner = fixture.debugElement.query(By.css('[data-testid="ion-spinner"]'));
    ...
    describe('Disabled', () => {
        it('should not select disabled option', () => {
            ...
            const optionElement = fixture.debugElement.query(By.css('.ion-dropdown-item'));
            optionElement.triggerEventHandler('click', null);
            fixture.detectChanges();

            expect(optionElement.nativeElement.classList).toContain('dropdown-disabled');
            expect(optionElement.nativeElement.classList).not.toContain('dropdown-item-selected');
        });
    });
    ...
    describe('Clear Button', () => {
        it('should show clear button when multiple options are selected', async () => {
            ...
            const clearButton = fixture.debugElement.query(By.css('[data-testid="button-clear"]'));
            if (clearButton) {
