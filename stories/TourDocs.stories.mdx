...
- `ionStepSkipBtnTitle` é o texto do botão de pular o tour. O botão só será exibido quando o usuário estiver na primeira etapa do tour;
...
- `ionStepFinishBtnTitle` é o texto do botão de finalizar o tour. O botão só será exibido se a etapa for a última do tour;
