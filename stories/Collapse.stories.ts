...
const TemplateCollapseMainContent: Story = (args) => ({
  props: args,
  template: `<ion-collapse name="Collapse name example"><p style="margin:0">The main code should go here</p></ion-collapse>`,
  moduleMetadata: {
    imports: [CommonModule, IonIconModule, IonCollapseModule],
  },
});

export const collapse = TemplateCollapseMainContent.bind({});
...
export const CollapseCustomHeader = TemplateCollapseCustomHeader.bind({});
