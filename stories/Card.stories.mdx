...
import { IonChipComponent } from '../projects/ion/src/lib/chip/chip.component.ts';
import { IonInfoBadgeComponent } from '../projects/ion/src/lib/info-badge/info-badge.component.ts';
...
<Canvas>
  <Story
    ...
    decorators={[
      moduleMetadata({
        declarations: [IonChipComponent, IonInfoBadgeComponent],
