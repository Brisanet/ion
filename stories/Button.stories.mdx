...
<Canvas>
  ...
  >
    {{
      template: `<ion-button iconType="pencil"></ion-button>`,
    }}
  </Story>
  <Story
  ...
  >
    {{
      template: `<ion-button iconType="pencil" [danger]="true"></ion-button>`,
    }}
  </Story>
  <Story
  ...
  >
    {{
      template: `<ion-button label="Deletar" iconType="trash"></ion-button>`,
    }}
  </Story>
  <Story
  ...
  >
    {{
      template: `<ion-button label="Deletar" iconType="trash" [danger]="true"></ion-button>`,
    }}
  </Story>
</Canvas>
...
- `circleBorder`. Transforma a bordas do botão em formato de círculo. Apenas o ícone será exibido.
...
<Canvas>
  ...
  >
    {{
      template: `<ion-button label="Editar" iconType="pencil" [circleBorder]="true"></ion-button>`,
    }}
  </Story>
  <Story
    name="circleBorder: trash danger"
    decorators={[
      moduleMetadata({
        declarations: [ButtonComponent, IonIconComponent],
        imports: [CommonModule],
  ...
  >
    {{
      template: `<ion-button label="Deletar" iconType="trash" [danger]="true" [circleBorder]="true"></ion-button>`,
    }}
  </Story>
</Canvas>
