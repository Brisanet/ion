...
<Canvas>
  ...
  >
    {{
      template: `<ion-button iconType="pencil" title="pencil" size="sm"></ion-button>`,
    }}
  </Story>
  <Story
  ...
  >
    {{
      template: `<ion-button iconType="pencil" [danger]="true" title="danger pencil" size="md"></ion-button>`,
    }}
  </Story>
  <Story
...
<Canvas>
  ...
  >
    {{
      template: `<ion-button label="Editar" iconType="pencil" title="pencil" [circularButton]="true"></ion-button>`,
    }}
  </Story>
  <Story
  ...
  >
    {{
      template: `<ion-button label="Deletar" iconType="trash" title="trash" [danger]="true" [circularButton]="true"></ion-button>`,
    }}
  </Story>
</Canvas>
